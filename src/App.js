  ...
  return (
    <div className="App">
      <header className="App-header">
        <NavBar />
        <br />
          <div className={`main-container ${ location.pathname === '/login' || location.pathname === '/sign-up' ? "justify-items-center" : ""}`}>
            ...
            <div className="col-span-full lg:col-span-6 flex justify-between cursor-pointer mb-3">
              ...
              <div className="self-right cursor-pointer">
                { location.pathname !== "/questions/new" && location.pathname !== "/login" && location.pathname !== "/sign-up" &&
