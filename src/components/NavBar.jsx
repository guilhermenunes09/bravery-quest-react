      ...
      <nav class="nav">
         <div class="flex flex-wrap justify-between items-center mx-auto">
            ...
            <div class="flex md:order-1">
               ...
               <button onClick={ () => { setSidebarOpen(!sidebarOpen) }} data-collapse-toggle="dropdown-menu" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
            ...
            <aside className={`sidebar ${ sidebarOpen ? 'sidebar-opened' : 'sidebar-closed' } x-64`}>
               <div className='overflow-y-auto py-4 px-3 bg-gray-50 rounded'>
                  <ul className='space-y-2'>
                     ...
                     <li>
                        { !isLoggedIn && 
                           <div onClick={handleLogout} className='nav-link cursor-pointer' href='#' className='flex items-center p-2 text-base font-normal text-gray-900 group-hover:text-gray-900 rounded-lg'>
